...
export default function App() {
  ...
  async function leerPDF(evento) {
    ...
    try {
      ...
      setTextoPDF(textoCompleto.trim());
    } catch (error) {
      console.error(error);
  ...
  return (
    <main className="contenedor">
      <section className="hero">
        ...
        <p>
          Cargá compras, préstamos o pagos en cuotas, subí resúmenes bancarios
          en PDF y visualizá cómo se proyectan tus gastos a futuro.
        </p>
      </section>
      ...
      <section className="panel">
        <div className="encabezado-panel">
          <div>
            ...
            <p className="texto-ayuda">
              Subí el resumen de tu tarjeta o banco. La app extrae el texto del
              PDF para que luego podamos detectar consumos, cuotas y vencimientos.
            </p>
          </div>
        ...
        {leyendoPDF && <p className="modo-edicion">Leyendo PDF...</p>}
